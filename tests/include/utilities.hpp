#ifndef VARERR_TESTS_UTILITIES_HPP
#define VARERR_TESTS_UTILITIES_HPP
...
// Convenient aliases for std::integral_constant<std::size_t, I>

template <std::size_t I>
using index_constant = std::integral_constant<std::size_t, I>;

template <std::size_t I>
using mask_constant = std::integral_constant<std::size_t, I>;
...
template <typename T, typename F>
constexpr void iterate_cref_matrix(F f) {
    f(std::type_identity<T> {});
    f(std::type_identity<const T> {});
    f(std::type_identity<T&> {});
    f(std::type_identity<const T&> {});
